 ...
 * @since  0.0.1
 */
class ObservatorioViewRecords extends JViewLegacy
{
    /**
    ...
    {
        JToolbarHelper::title('Registros');
        JToolBarHelper::link( JURI::base().'?option=com_observatorio&view=batches', 'Volver');
