 ...
 * @since  0.0.1
 */
class ObservatorioModelBatch extends JModelAdmin
{
    /**
     ...
     * @since   1.6
     */
    public function getTable($type = 'Batch', $prefix = 'ObservatorioTable', $config = array())
    {
    ...
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState(
            'com_observatorio.edit.batch.data',
            array()
        );
